...
def optimized_combinatorial_search(Q, num_terms=20, min_val=2**248, max_val=order, samples=12500000):
    """
...
# 150000000
def parallel_combinatorial_search_for_all(Q_list, x_coords, num_terms=256, min_val=2**128, max_val=2**129, 
                                          total_samples=250000, num_workers=12):
    results = {}
